  ...
  exercises: [
    {
      ...
      label: <>Definition (1)</>,
      problem: <p>
        Give the definition of a (binary) relation between the sets A and B.
      </p>,
      answer: <>
    ...
    },
    {
      ...
      problem: <>
        ...
        {mathDiv("B = #{3, 4, 5, 6, 7#}")}
        <p>
          Which of the following is a (binary) relation between
          <ul>
            <li>A and B</li>
            <li>B and A</li>
            <li>A and itself</li>
      ...
      answer: <>
        ...
        <p>A relation between A and itself is therefore a subset of {mathSpan("A #times A")}.</p>
        ...
        <ul>
          ...
          <li>
            X_6 is a relation between A and itself, but <b>not</b> between any of
            <ul>
              <li>B and itself</li>
              <li>A and B</li>
              <li>B and A</li>
          ...
          <li>X_8 is a relation between A and itself, as well as A and B, but not between B and A nor B and itself.</li>
          <li>
            X_9 is a relation between
            <ul>
              <li>A and itself</li>
              <li>B and itself</li>
              <li>A and B</li>
