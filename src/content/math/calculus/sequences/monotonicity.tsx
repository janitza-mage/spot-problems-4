...
export const monotonicity: Collection = {
  ...
  exercises: [
    ...
    {
      type: "exercise",
      label: "Multiple monotonicity properties at the same time",
      problem: <>
      ...
      answer: <>
        <p>
          A sequence can fall into one of these cases:
        </p>
        <ul>
          ...
          <li>Constant, and thus both weakly increasing and weakly decreasing, but neither strictly
            increasing nor strictly decreasing</li>
